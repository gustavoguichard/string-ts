...
export type { EndsWith, WhenEndsWith } from './native/ends-with.js'
export { endsWith, endsWithGuard } from './native/ends-with.js'
export type { Includes, WhenIncludes } from './native/includes.js'
export { includes, includesGuard } from './native/includes.js'
...
export type { StartsWith, WhenStartsWith } from './native/starts-with.js'
export { startsWith, startsWithGuard } from './native/starts-with.js'
